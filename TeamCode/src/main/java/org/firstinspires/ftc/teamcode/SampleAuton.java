...
public class SampleAuton extends OpMode{
    ...
    public void loop() {
        ...
        if (((VuforiaTrackableDefaultListener)redFootprint.getListener()).isVisible())
        {
            leftPower = 0.5;
            rightPower = 0.5;
            targetVisible = true;

            trackable = redFootprint;

        } else if (((VuforiaTrackableDefaultListener)blueRover.getListener()).isVisible()) {
            leftPower = -0.5;
            rightPower = -0.5;
            targetVisible = true;
            trackable = blueRover;
